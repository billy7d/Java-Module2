...
public class readNumber {
    public static void main(String[] args) {
        ...
        int hangChuc = (number - hangDonVi)/10;
        ...
        if (number >= 0 && number < 10) {
            ...
            System.out.println(docHangDonVi);
            ...
            switch (hangTram) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    docHangTram = "five_hundred";
                    break;
                case 6:
                    docHangTram = "six_hundred";
                    break;
                case 7:
                    docHangTram = "seven_hundred";
                    break;
                case 8:
                    docHangTram = "eight_hundred";
                    break;
                case 9:
                    docHangTram = "nine_hundred";
                    break;
